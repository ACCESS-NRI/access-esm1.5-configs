...
d = netCDF4.Dataset('aera_input_PI.nc', 'w')
...
d = netCDF4.Dataset('aera_input_PI.nc', 'r+')
time_var = d.variables['time']
time_bnds = d.variables['time_bnds']
tas_var = d.variables['tas']
co2_var = d.variables['co2']
time_units = cf_units.Unit("days since 0001-01-01 00:00", calendar='proleptic_gregorian')
